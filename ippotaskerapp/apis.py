...
from ippotaskerapp.models import Restaurant, Meal, Order, OrderDetails, Driver
from ippotaskerapp.serializers import RestaurantSerializer, \
    MealSerializer, \
    OrderSerializer

import stripe
from ippotasker.settings import STRIPE_API_KEY
